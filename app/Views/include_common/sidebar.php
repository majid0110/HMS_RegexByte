...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <a class="nav-link" href="<?= base_url('dashboard'); ?>">
        ...
        ?>
            ...
            <?php if ($canView): ?>
                <li class="nav-item nav-category"><?= $module['module_name'] ?></li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic-<?= $moduleID ?>">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url('user_form'); ?>"> <?= $module['module_name'] ?></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="<?= base_url('business_table'); ?>">View <?= $module['module_name'] ?></a>
                            </li>
                        </ul>
                    </div>
                </li>
    ...
    <?php if ($canView): ?>
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic-<?= $moduleID ?>">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url( 'clients_form'); ?>">Add <?= $module['module_name'] ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url( 'clients_table'); ?>">View <?= $module['module_name'] ?></a>
                    </li>
                    <!-- Add more sub-menu items as needed -->
                </ul>
            </div>
    ...
    <?php if ($canView): ?>
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic-<?= $moduleID ?>">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url( 'appointments_form'); ?>">Book <?= $module['module_name'] ?></a>
                    </li>
                    <li class="nav-item">
    ...
    <?php if ($canView): ?>
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic-<?= $moduleID ?>">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('doctors_form'); ?>">Add <?= $module['module_name'] ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('doctors_table'); ?>">View <?= $module['module_name'] ?></a>
                    </li>
                    <li class="nav-item">
    ...
    <?php if ($canView): ?>
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic-<?= $moduleID ?>">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url( 'add_reports'); ?>">Add Reports</a>
                    </li>
                    <!-- Add more sub-menu items as needed -->
                </ul>
            </div>
