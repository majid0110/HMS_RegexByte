      ...
      <?php
        ...
        <div class="row">
            <div class="col-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">LAB SERVICES</h4>
                        <!-- Form for adding/editing doctor fee -->
                       <form class="pt-3" method="POST" action="<?php echo base_url() . "saveLabService"; ?>" enctype="multipart/form-data">
                            ...
                            <div class="row">
                               <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="ls_fee" />
                                        </div>
                                    </div>
                                </div>
                            </div>
