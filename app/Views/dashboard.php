                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="statistics-details d-flex align-items-center justify-content-between">
                          <div>
                            <div>
                              <p class="statistics-title">Total Doctors</p>
                              <h3 class="rate-percentage"><?php echo $totalDoctorCount; ?></h3>
                            </div>
                          </div>
                          <div>
                          ...
                          <div>
                            <p class="statistics-title">Total Appointments</p>
                            <h3 class="rate-percentage">0</h3>
                            
                          </div>
                          <div class="d-none d-md-block">
                            <p class="statistics-title">Appointments Revenue</p>
                            <h3 class="rate-percentage">0</h3>
                            ...
                            <div class="card card-rounded">
                              <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                    <h4 class="card-title card-title-dash">Performance</h4>
                                  ...
                                  <table class="table select-table">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex ">
                                            <img src="./public/assets/images_s/faces/face1.jpg" alt="">
                                            <div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="./public/assets/images_s/faces/face2.jpg" alt="">
                                            <div>
                                              <h6>Laura Brooks</h6>
                                              <p>Head admin</p>
                                            </div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="./public/assets/images_s/faces/face3.jpg" alt="">
                                            <div>
                                              <h6>Wayne Murphy</h6>
                                              <p>Head admin</p>
                                            </div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="./public/assets/images_s/faces/face4.jpg" alt="">
                                            <div>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="d-flex">
                                            <img src="./public/assets/images_s/faces/face5.jpg" alt="">
                                            <div>
                                  ...
                                  <div class="col-lg-12">
                                    ...
                                    <div class="mt-3">
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="./public/assets/images_s/faces/face1.jpg" alt="profile">
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="./public/assets/images_s/faces/face2.jpg" alt="profile">
                                          <div class="wrapper ms-3">
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="./public/assets/images_s/faces/face3.jpg" alt="profile">
                                          <div class="wrapper ms-3">
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between py-2 border-bottom">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="./public/assets/images_s/faces/face4.jpg" alt="profile">
                                          <div class="wrapper ms-3">
                                      ...
                                      <div class="wrapper d-flex align-items-center justify-content-between pt-2">
                                        <div class="d-flex">
                                          <img class="img-sm rounded-10" src="./public/assets/images_s/faces/face5.jpg" alt="profile">
                                          <div class="wrapper ms-3">
