              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <td><?= $client['CNIC']; ?></td>
                    <td><?= $client['status']; ?></td>
                    <td><?= $client['idBusiness']; ?></td>
                    <td>
                        <!-- Action buttons: Edit and Delete -->
                           <a href="<?= base_url("ClientController/editDoctor/{$client['idClient']}") ?>" class="btn btn-warning btn-sm">Edit</a>
                           <a href="<?= base_url('deleteClient/' . $client['idClient']); ?>" onclick="return confirm('Are you sure you want to delete this client?');" class="btn btn-danger btn-sm">Delete</a>
                </tr>
            <?php endforeach; ?>
